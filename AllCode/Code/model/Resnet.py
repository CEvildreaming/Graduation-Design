...
def resnet18(num_classes=8,include_top=True,pretrained=False):
    return ResNet(BasicBlock,[2,2,2,2],num_classes=num_classes,include_top=include_top)

def resnet34(num_classes=8,include_top=True,pretrained=False):
    return ResNet(BasicBlock,[3,4,6,3],num_classes=num_classes,include_top=include_top)

def resnet50(num_classes=8,include_top=True,pretrained=False):
    return ResNet(Bottleneck,[3,4,6,3],num_classes=num_classes,include_top=include_top)

def resnet101(num_classes=8,include_top=True,pretrained=False):
